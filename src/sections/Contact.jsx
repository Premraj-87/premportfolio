...
export default function Contact() {
  ...
  const sendEmail = async (e) => {
    ...
    try {
      const res = await axios.post("/api/send", data, {
        headers: {
          "x-secret-key": "premraj@2025!contact_secure",
        },
      });
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="md:w-1/3 w-full flex justify-center">
          <div className="bg-[#f1f5f9] dark:bg-[#0f172a] border border-gray-300 dark:border-gray-700 rounded-xl p-6 shadow-lg flex flex-col items-center justify-center gap-6">
            <h3 className="text-2xl font-semibold text-[#FF6F61]">
              Let's Connect
            </h3>
            ...
            <div className="space-y-4 text-center">
              <a
                ...
                className="flex items-center gap-2 justify-center text-black dark:text-white hover:text-[#FF6F61] transition"
              >
        ...
        <div className="md:w-2/3 w-full">
          <h2 className="text-4xl font-bold text-[#FF6F61] mb-8 text-center md:text-left">
            Contact Me
          </h2>
          ...
          <div className="bg-[#e2e8f0] dark:bg-[#0f172a] border border-gray-300 dark:border-gray-700 p-8 rounded-lg shadow-lg">
            <form className="space-y-5" onSubmit={sendEmail}>
              ...
              <button
                type="submit"
                className="bg-[#FF6F61] text-black font-semibold px-6 py-2 rounded-md hover:bg-[#e65a50] transition duration-300"
              >
                Send Message
              </button>
            </form>
      ...
      {/* Footer */}
      <div className="mt-24 text-sm text-[#FF6F61] text-center">
      ...
      {showScroll && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-20 right-6 z-50 p-3 rounded-full bg-[#FF6F61] text-black shadow-lg hover:bg-[#e65a50] transition duration-300"
