...
export default function Experience() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto border border-[#FF6F61]/30 rounded-2xl p-8 sm:p-12 shadow-md dark:shadow-lg dark:border-[#FF6F61]/20">
        <h2 className="text-4xl font-bold text-center text-[#FF6F61] mb-12">
          Experience
        </h2>

        <div className="relative pl-10 sm:pl-12">
          {/* Vertical line */}
          <div className="absolute top-0 left-4 sm:left-5 h-full w-[2px] bg-[#FF6F61]/40" />
