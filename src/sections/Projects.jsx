...
const projects = [
  {
    ...
    description: "An AI-powered dynamic portfolio builder with live preview, custom themes, and markdown content support.",
  ...
  {
    title: "TaskSync Pro",
    description: "A full-stack task and productivity app with calendar integration and real-time sync features.",
  ...
  },
  {
    ...
    description: "A visually engaging startup landing page built with GSAP scroll animations and modern design.",
  ...
  },
  {
    ...
    description: "A reusable and animated e-commerce frontend UI with beautiful product cards and cart logic.",
  ...
  {
    title: "Blogify CMS",
    description: "A simple and responsive blog content management app with markdown support and dashboard UI.",
  ...
  {
    title: "EventEase",
    description: "An animated event listing platform with filterable cards, RSVP system, and interactive UI.",
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-16 text-[#DAA520]">
          Projects
        </h2>
              ...
              <div className="p-5 space-y-3">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {project.tech.map((tech, index) => (
                    <span
                      key={index}
                      className="bg-[#DAA520]/10 text-[#DAA520] text-xs px-2 py-1 rounded-md"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        {selected && (
          <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center px-4">
            <div className="bg-white dark:bg-gray-900 rounded-xl max-w-2xl w-full p-6 relative shadow-xl">
              ...
              />
              <h3 className="text-2xl font-bold text-[#DAA520] mb-2">
                {selected.title}
              </h3>
              ...
              <a
                ...
                className="inline-block mt-2 bg-[#DAA520] text-black font-medium py-2 px-4 rounded hover:bg-[#e0be4d] transition"
              >
                View Live Project
              </a>
            </div>
